        ...
        <div className="text-center">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
            <p className="text-gray-600 dark:text-gray-300 text-lg leading-relaxed">
              This page is coming soon. We're developing a comprehensive contact
              form and information page.
            </p>
            <div className="mt-8 p-6 bg-gradient-to-r from-medoscopic-blue-50 to-medoscopic-teal-50 dark:from-medoscopic-blue-900/20 dark:to-medoscopic-teal-900/20 rounded-lg">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                For immediate assistance, please call +1 (555) 123-4567 or email
                info@medoscopic.com
              </p>
            </div>
          </div>
